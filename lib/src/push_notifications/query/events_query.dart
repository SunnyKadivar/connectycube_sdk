...
class CreateEventQuery extends AutoManagedQuery<List<CubeEvent>> {
  ...
  setParams(RestRequest request) {
    ...
    putValue(parameters, 'event', eventJson);
  }
...
class CreateEventParams {
  ...
  String environment;
  String eventType;
  List<int> usersIds = List();
  List<int> externalUsersIds = List();
  List<String> usersTagsAll = List();
  List<String> usersTagsAny = List();
  List<String> usersTagsExclude = List();
  int date;
  int endDate;
  int period;
  String name;
