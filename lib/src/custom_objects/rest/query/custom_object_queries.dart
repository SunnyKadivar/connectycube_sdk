...
class UpdateCustomObjectByCriteriaQuery extends AutoManagedQuery<PagedCustomObjectResult> {
  String _className;
  Map<String, dynamic> _params;
...
class DeleteCustomObjectsByIdsQuery extends AutoManagedQuery<DeleteItemsResult> {
  List<String> _ids;
  String _className;
  ...
  @override
  setUrl(RestRequest request) {
    if (_ids == null || _ids.isEmpty || isEmpty(_className)) {
      throw IllegalArgumentException(
