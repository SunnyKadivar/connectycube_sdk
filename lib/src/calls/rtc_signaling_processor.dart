...
class RTCSignalingProcessor {
  ...
  void _processSignalingMessage(MessageStanza signalingMessage) {
    ...
    int callerId = int.parse(params[SignalField.CALLER]);
    int callType = int.parse(params[SignalField.CALL_TYPE]);
