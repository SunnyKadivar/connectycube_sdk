...
class CubeRTCSessionDescription {
  ...
  CubeRTCSessionDescription.withSession(this.sessionId, this.callerId,
      this.opponents, this.conferenceType, [this.userInfo]);

  CubeRTCSessionDescription(
      this.callerId, this.opponents, this.conferenceType, [this.userInfo]) {
